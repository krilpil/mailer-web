...
- Приватные: `src/app/(private)/page.tsx`, `src/app/(private)/mailings/page.tsx`, `src/app/(private)/mailing/page.tsx`, `src/app/(private)/templates/page.tsx`, `src/app/(private)/contacts/page.tsx`, `src/app/(private)/mailboxes/page.tsx`, `src/app/(private)/settings/page.tsx`.
